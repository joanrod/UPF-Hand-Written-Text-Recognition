...
class DocScanner(object):
    ...
    def scan(self, image):
        ...
        OUTPUT_DIR = '/Users/joanrodriguezgarcia/PycharmProjects/GaussSmartPen/data/output'
        ...
        thresh = cv2.adaptiveThreshold(sharpen, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 21, 5)
